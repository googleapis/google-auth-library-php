...
/**
 * ProxyAuthTokenSubscriber is a Guzzle Subscriber that adds an Authorization header
 ...
 */
class ProxyAuthTokenSubscriber implements SubscriberInterface
{
    /**
     * @var callable
     */
     ...
     *     'defaults' => ['proxy_auth' => 'google_auth']
     * ]);
    ...
    public function onBefore(BeforeEvent $event)
    {
        ...
        if ($request->getConfig()['proxy_auth'] != 'google_auth') {
            return;
        }
        ...
        if (array_key_exists('access_token', $auth_tokens)) {
            $request->setHeader('proxy-authorization', 'Bearer ' . $auth_tokens['access_token']);
